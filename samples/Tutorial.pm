...
for my $n (sort { $a cmp $b } keys %part) {
    ...
    my $contents= expand_body(@{ $part{'COMMON'} }[1], $n);
    ...
    # my $contents= expand_body($body, $n);
    $contents .= expand_body($body, $n);
...
=head1 SAMPLE1: Minimal Configuration
...
So, rabak sees one backup set named 'sample', which will backup all files
