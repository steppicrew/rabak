...
ok $oPath->copyLoc2Rem("$sOrigPath/test", "test2"), 1, "Copying local file to remote 1";
ok $oPath->cat("test2"), "some data\n", 'Checking copied data 1';
ok $oPath->copyLoc2Rem("$sOrigPath/test", "test2", 1), 1, "Appending local file to remote";
ok $oPath->cat("test2"), "some data\nsome data\n", 'Checking appended data';
ok $oPath->copyLoc2Rem("$sOrigPath/test", "test2"), 1, "Copying local file to remote 2";
...
ok !!$oPath->isReadable("test2"), '', 'Checking isReadable() on file without rights';
ok !!$oPath->isWritable("test2"), '', 'Checking isWritable() on file without rights';
...
ok !!$oPath->isDir("test3"), '', 'Checking isDir() on symlink';
ok !!$oPath->isFile("test3"), 1, 'Checking isFile() on symlink';
ok !!$oPath->isReadable("test3"), '', 'Checking isReadable() on symlink';
ok !!$oPath->isWritable("test3"), '', 'Checking isWritable() on symlink';
ok !!$oPath->unlink("test3"), 1, 'Deleting symlink';
